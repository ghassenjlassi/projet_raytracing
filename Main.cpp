...
int main (int argc,  char *argv[]) {
	...
	*/
	...
	/*
     @brief Colors
	 */
	Material green(0.5,1.0,0.5, 0.2);
	Material gray(0.4, 0.4, 0.4, 0.0);
	Material red(1.0, 0.5, 0.5, 0.3);
	Material white(1, 1, 1, 1);
	/*
     @brief initialize the "sphere"
    */
	Sphere scene_sphere1(green,Vector3f(20,1,0),2);
	Sphere scene_sphere2(red, Vector3f(5,-1,1),1);
